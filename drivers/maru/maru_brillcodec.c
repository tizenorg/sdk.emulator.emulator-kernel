...
static bool get_device_info(void)
{
	...
	// we check only major version
	brillcodec_device->version = (int)((info & 0x00000F00) >> 8);
	...
	brillcodec_device->memory_monopolizing = (info & 0x000F0000) >> 16;
